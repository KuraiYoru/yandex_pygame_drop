class AbstractProvider(object):
    ...
    def find_matches(self, requirements):
        """Find all possible candidates that satisfy the given requirements.txt.
        ...
        :param requirements: A collection of requirements.txt which all of the the
            returned candidates must match. All requirements.txt are guaranteed to
